...
// import { Player, Team } from '@/store/type'
...
//   allPlayers,
// }: TeamBuilderProps) {
//   const { activeTournamentId, addMatch, loading } = useTournamentStore()
...
//       selected.map((player1) => {
//         return getOrCreateTeam(player1)
//       })
//     )
